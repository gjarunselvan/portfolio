...
const TECH_ICONS: TechItem[] = [
  {
    ...
    color: "#326CE5",
    achievements: [
      "Designed and operated Kubernetes services on Amazon EKS for resilient enterprise platforms.",
      "Used Helm and Argo CD GitOps practices to standardize cloud-native workload delivery.",
      "Scaled production services through 3x traffic growth with zero-downtime continuity.",
    ],
  },
  {
    Icon: SiDocker,
    ...
    color: "#0DB7ED",
    achievements: [
      "Standardized Docker-based build and release workflows across delivery environments.",
      "Supported blue-green and canary deployment patterns for safer production rollout.",
      "Reduced environment drift across pre-production and production stages.",
    ],
  },
  {
    Icon: SiJenkins,
    ...
    color: "#D24939",
    achievements: [
      "Architected enterprise CI/CD pipelines with Jenkins, GitHub Actions, and GitLab CI.",
      "Improved release frequency by 40%+ with controlled automation and promotion gates.",
      "Reduced deployment risk through auditable release workflows, blue-green rollouts, and canary releases.",
    ],
  },
  {
    Icon: SiTerraform,
    ...
    achievements: [
      ...
      "Automated platform operations with Ansible, Python, Bash, and Linux administration practices.",
      "Accelerated environment provisioning while improving governance, traceability, and rollout confidence.",
    ],
  },
  {
    Icon: SiAmazon,
    ...
    achievements: [
      ...
      "Worked across Azure, WCNP, and OneOps cloud platform environments.",
  ...
  },
  {
    ...
    color: "#64748B",
    achievements: [
      "Administered and hardened Linux production environments across RHEL and Ubuntu estates.",
      "Sustained 99.99% uptime for mission-critical services.",
      "Improved security posture through patch governance, baseline hardening, and routine maintenance automation.",
    ],
  },
  {
    Icon: SiPrometheus,
    ...
    color: "#E6522C",
    achievements: [
      "Implemented observability with Prometheus, Grafana, Splunk, and ELK Stack.",
      "Improved failure detection with platform-level telemetry across service and infrastructure layers.",
  ...
  },
  {
    ...
    color: "#F46800",
    achievements: [
      "Built high-availability practices around disaster recovery, RTO/RPO, and incident readiness.",
      "Created dashboards for platform health, service behavior, and incident context.",
  ...
  },
  {
    ...
    color: "#3776AB",
    achievements: [
      "Built AI-driven DevOps workflows for diagnostics, release intelligence, and infrastructure documentation.",
      "Applied LLM, RAG, and multi-agent patterns to operational knowledge and decision support.",
      "Integrated AIOps automation concepts into platform engineering workflows.",
    ],
  },
  {
    Icon: SiGit,
    ...
    color: "#F1502F",
    achievements: [
      "Strengthened IAM policy governance, security hardening, and vulnerability management practices.",
      "Supported TCP/IP, DNS, load balancing, firewall, and network reliability workflows.",
...
const EXPERIENCE: ExperienceItem[] = [
  ...
  },
  {
    ...
    location: "India",
    summary:
      "Built the operations foundation across AWS cloud support, Linux administration, monitoring, automation, and production incident response that later scaled into senior platform engineering.",
    highlights: [
      "AWS and Linux production operations",
      "Backup, patching, and user workflow automation",
      "Prometheus and Grafana monitoring",
      "Runbook standardization and incident reduction",
    ],
    metrics: [
      { label: "Cloud", value: "AWS" },
      { label: "Platform", value: "Linux" },
      { label: "Delivery Mode", value: "Automation" },
      { label: "Support", value: "L2/L3" },
    ],
    bullets: [
      "Administered and hardened Linux production environments on AWS and automated backup, patching, and user workflows using Bash.",
      "Implemented Prometheus and Grafana monitoring for proactive issue detection and faster incident response.",
      "Provided L2/L3 support for complex production infrastructure and application incidents in AWS cloud and Linux environments.",
